/**
 * Returns the raw contents of the node gitignore file.
 * TODO: Callout to pull this data fresh from https://github.com/github/gitignore
 */
export function getGitignoreContents() : string {
	return `# Logs
logs
*.log
npm-debug.log*
...
###############################################################################################
# Everything above this line was taken from Github's public gitignore repo for node js projects
